...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 31, 2024 at 04:19 PM
...
(5, 'Empowerment Technology', 'et101', 'sfn', 1, 'Noland   Duran Igut', 'Mon,Wed,Thurs', '1st Semester', '2024-2025', 1);
...
CREATE TABLE `class_schedule` (
  ...
  `classroom_location` varchar(100) DEFAULT NULL,
  `attendance_allotment` time NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `class_schedule` (`schedule_id`, `subject_id`, `section_id`, `meeting_days`, `start_time`, `end_time`, `classroom_location`, `attendance_allotment`) VALUES
(2, 3, 1, 'Wed', '22:05:00', '23:05:00', NULL, '00:00:00');
...
ALTER TABLE `class_schedule`
  ...
  ADD CONSTRAINT `class_schedule_ibfk_3` FOREIGN KEY (`meeting_days`) REFERENCES `classsubject` (`meeting_days`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
