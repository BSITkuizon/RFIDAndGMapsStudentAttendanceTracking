...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 02, 2024 at 06:10 AM
...
--
-- Table structure for table `classtimeschedule`
--

CREATE TABLE `classtimeschedule` (
...
--
-- Dumping data for table `classtimeschedule`
--

INSERT INTO `classtimeschedule` (`sched_id`, `subject_name`, `day_of_week`, `start_time`, `end_time`, `classroom_location`, `section`) VALUES
(11, 'Programming 3', 'Monday', '14:26:00', '15:26:00', 'ROOM 2', '11 Athena'),
(12, 'Programming 3', 'Wednesday', '14:26:00', '15:26:00', 'ROOM 2', '11 Athena'),
(13, 'Programming 3', 'Tuesday', '14:26:00', '15:26:00', 'ROOM 2', '11 Athena'),
(14, 'Programming 3', 'Tuesday', '14:26:00', '15:26:00', 'ROOM 2', '11 Athena'),
(15, 'Science', 'Monday', '15:00:00', '16:00:00', 'ROOM 5', 'SECTION 1'),
(16, 'Science', 'Tuesday', '15:00:00', '16:00:00', 'ROOM 5', 'SECTION 1'),
(17, 'Science', 'Thursday', '15:00:00', '16:00:00', 'ROOM 5', 'SECTION 1'),
(18, 'MATH', 'Monday', '19:34:00', '17:34:00', 'ROOM 1', '11 Athena'),
(19, 'MATH', 'Wednesday', '19:34:00', '17:34:00', 'ROOM 1', '11 Athena'),
(20, 'MATH', 'Friday', '19:34:00', '17:34:00', 'ROOM 1', '11 Athena'),
(21, 'MATH', 'Tuesday', '19:34:00', '17:34:00', 'ROOM 1', '11 Athena'),
(22, 'MATH', 'Thursday', '19:34:00', '17:34:00', 'ROOM 1', '11 Athena');

-- --------------------------------------------------------

--
-- Table structure for table `shortenedtime`
--

CREATE TABLE `shortenedtime` (
  `shortened_id` int(11) NOT NULL,
  `shortened_start_time` time NOT NULL,
  `shortened_end_time` time NOT NULL,
...
--
-- Dumping data for table `shortenedtime`
--

INSERT INTO `shortenedtime` (`shortened_id`, `shortened_start_time`, `shortened_end_time`, `effective_date`, `reason`, `start_date`, `end_date`, `subject_name`) VALUES
(1, '14:39:00', '15:22:00', '2024-07-31', 'none', '2024-07-31', '2024-07-31', 'Programming 2');
...
(1, 'Physical Education', 'PE101', 'Noland Duran Igut', '11 Athena', 'M,W,T,Thurs', 1, '2024-2025'),
...
(6, 'Programming 3', 'IT103', 'Noland Duran Igut', '11 Athena', 'M,W,T,Thurs', 1, '2024-2025'),
(9, 'Science', 'SCI101', 'Noland Duran Igut', '11 Athena', 'Mon,Tues,Thurs', 1, '2024-2025'),
(10, 'MATH', 'MA101', 'Noland Duran Igut', '11 Athena', 'Mon,Wed,Fri,Tues,Thurs', 1, '2024-2025');
...
--
-- Indexes for table `classtimeschedule`
--
ALTER TABLE `classtimeschedule`
  ADD PRIMARY KEY (`sched_id`),
  ADD KEY `subject_name` (`subject_name`);

--
-- Indexes for table `shortenedtime`
--
ALTER TABLE `shortenedtime`
  ADD PRIMARY KEY (`shortened_id`),
  ADD KEY `subject_name` (`subject_name`);
...
--
-- AUTO_INCREMENT for table `classtimeschedule`
--
ALTER TABLE `classtimeschedule`
  MODIFY `sched_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;

--
-- AUTO_INCREMENT for table `shortenedtime`
--
ALTER TABLE `shortenedtime`
  MODIFY `shortened_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- Constraints for table `classtimeschedule`
--
ALTER TABLE `classtimeschedule`
  ADD CONSTRAINT `classtimeschedule_ibfk_1` FOREIGN KEY (`subject_name`) REFERENCES `subject` (`subject_name`);

--
-- Constraints for table `shortenedtime`
--
ALTER TABLE `shortenedtime`
  ADD CONSTRAINT `shortenedtime_ibfk_1` FOREIGN KEY (`subject_name`) REFERENCES `subject` (`subject_name`);
COMMIT;
